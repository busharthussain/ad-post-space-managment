...
<div class="wrapper" style="display: block;margin:0 auto;background-color: #fff;max-width: 600px;">
  ...
  <div style="display: block;padding:10px">
    <strong style="font-size: 20px;">{{_lang('Dear')}} {!! $name !!},</strong>
    @if(!empty($isSubAdmin))
      <p style="font-size: 16px;">{!! $companyName !!} {{_lang('invited you as sub admin and here is your email')}} {!! $email !!} {{_lang('and password')}} {!! $password !!}.<br/> {{_lang('Please Login blow')}}</p>
    @else
      <p style="font-size: 16px;">{{_lang('Your company has been created in sharepeeps and here is your password')}} {!! $password !!}.<br/> {{_lang('Please Login blow')}}</p>
    @endif
