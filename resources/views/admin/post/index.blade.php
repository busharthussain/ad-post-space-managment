...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a class="btn btn-success pull-right" href="{!! URL::route('super.admin.create.post') !!}">{{_lang('Create Post')}}</a>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $renderRoute = '{{ URL::route('post.get') }}';
        $editRoute = '{{ URL::route('super.admin.edit.post') }}';
        $deleteRoute = '{!! URL::route('post.delete') !!}';
        $messageRoute = '{!! URL::route('post.message') !!}';
        $defaultType = 'renderPosts';
        $token = "{{ csrf_token() }}";
        $viewOnly = false;
        $page = 1;
        $search = '';
