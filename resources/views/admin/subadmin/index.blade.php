...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{_lang('Sub Admins')}}</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{!! URL::route('super.admin.dashboard') !!}">{{_lang('Home')}}</a></li>
                    <li class="breadcrumb-item">{{_lang('Sub Admins')}}</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a class="btn btn-success pull-right" href="{!! URL::route('super.admin.create.sub') !!}">{{_lang('Create Admin')}}</a>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $renderRoute = '{{ URL::route('sub.get') }}';
        $editRoute = '{{ URL::route('super.admin.edit.sub') }}';
        $deleteRoute = '{!! URL::route('sub.delete') !!}';
        $defaultType = 'renderSubAdmins';
        $token = "{{ csrf_token() }}";
        $page = 1;
        $search = '';
        $asc = 'asc';
