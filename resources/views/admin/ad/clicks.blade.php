...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{_lang('Ads Space Clicks')}}</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{!! URL::route('super.admin.dashboard') !!}">{{_lang('Home')}}</a></li>
                    <li class="breadcrumb-item">{{_lang('Ads Space Clicks')}}</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
    ...
    <script type="text/javascript">
        $renderRoute = '{{ URL::route('super.get.adspace.clicks') }}';
        $defaultType = 'renderAdsClicks';
        $token = "{{ csrf_token() }}";
        $page = 1;
        $search = '';
        $asc = 'asc';
